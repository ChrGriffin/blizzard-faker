...
class Diablo extends DataProvider implements DataProviderInterface
{
    ...
    protected static $names = [
        ...
        'Brother Malachi'               => ['first_only', 'male'],
        'Brother Malachi the Healer'    => ['full_only', 'male'],
        'Captain Davyd'                 => ['first_only', 'full_only', 'male'],
        'Captain Rumford'               => ['first_only', 'full_only', 'male'],
        'Captain Vonn'                  => ['first_only', 'full_only', 'male'],
        ...
        'Lieutenant Clyfton'            => ['first_only', 'full_only', 'male'],
        'Lieutenant Lavail'             => ['first_only', 'full_only', 'male'],
        'Lieutenant Merityn'            => ['first_only', 'full_only', 'male'],
        ...
        'Seargant Dalen'                => ['first_only', 'full_only', 'male'],
        'Seargant Pale'                 => ['first_only', 'full_only', 'male'],
